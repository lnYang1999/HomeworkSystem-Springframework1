    ...
    <form action="/addHomework" method="post">
        <table align="center" style="line-height: 40px; font-family: '华文楷体';">
            <tr>
                ...
                <td><input name="hw_id" type="text" required="required" size="40" maxlength="20"></td>
            </tr>
            <tr>
                <td nowrap="nowrap">作业标题：</td>
                <td><input name="hw_title" type="text" required="required" size="40" maxlength="20"></td>
            </tr>
            <tr>
                <td nowrap="nowrap">作业内容：</td>
                <td><textarea name="hw_content" cols="40" rows="10" required="required" ></textarea></td>
            </tr>
            <tr align="center">
