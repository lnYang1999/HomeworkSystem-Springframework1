...
<p style="margin: 50px; font-family: '华文宋体'; font-size: 50px; color: darkorange; text-align: center;"><%="学生删除成功!"%></p>

<%
}else {
%>

<p style="margin: 50px; font-family: '华文宋体'; font-size: 50px; color: darkorange; text-align: center;"><%="学生删除失败!"%></p>
...
<p style="margin: 50px; font-family: '华文宋体'; font-size: 50px; color: darkorange; text-align: center;"><%="作业删除成功!"%></p>

    <%
}else {
%>

<p style="margin: 50px; font-family: '华文宋体'; font-size: 50px; color: darkorange; text-align: center;"><%="作业删除失败!"%></p>
